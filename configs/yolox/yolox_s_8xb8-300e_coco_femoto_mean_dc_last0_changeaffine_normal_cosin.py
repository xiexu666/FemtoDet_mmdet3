...
work_dir = 'work_dirs/femtodet_stage0_mean_dc_last0_changeaffine_normal_cosin_4gpu_noautolr/'
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        data_root=data_root,
        ann_file='annotations_tp/testvoc2_annotations.json',
        data_prefix=dict(img='jpeg/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations_tp/testvoc2_annotations.json',
    metric='bbox',
    backend_args=backend_args)
