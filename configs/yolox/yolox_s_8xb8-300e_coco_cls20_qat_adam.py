...
# load_from = 'checkpoint/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth'
work_dir = 'work_dirs/yolox_s_8xb8-300e_coco_cls20'
# model settings
model = dict(
    type='YOLOX',
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(
        type='Adam', lr=1e-5, weight_decay=1e-4,
        nesterov=True),
